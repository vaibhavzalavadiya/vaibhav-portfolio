...
export const tools = [
  { name: "VS Code", icon: "fas fa-code", color: "text-blue-500", category: "Editor" },
  { name: "Git", icon: "fab fa-git-alt", color: "text-orange-500", category: "Version Control" },
  { name: "GitHub", icon: "fab fa-github", color: "text-gray-800", category: "Platform" },
  { name: "Figma", icon: "fab fa-figma", color: "text-purple-500", category: "Design" },
  { name: "Chrome DevTools", icon: "fab fa-chrome", color: "text-green-500", category: "Debug" },
  { name: "Postman", icon: "fas fa-paper-plane", color: "text-orange-600", category: "API" },
  { name: "Netlify", icon: "fas fa-globe", color: "text-teal-500", category: "Deploy" },
  { name: "Vercel", icon: "fas fa-rocket", color: "text-black", category: "Deploy" }
];
